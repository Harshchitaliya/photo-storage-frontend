const Button = {
  button: {
    ...
    color: {
      ...
      info: "border border-transparent bg-cyan-700 text-white focus:ring-4 focus:ring-cyan-300 enabled:hover:bg-gray-800 dark:bg-gray-600 dark:focus:ring-gray-800 dark:enabled:hover:bg-gray-700",
      light:
